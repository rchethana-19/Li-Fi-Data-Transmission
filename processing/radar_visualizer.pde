...
void setup() {
  ...
  smooth();
  // Update the port name as needed (e.g., "COM5" on Windows, "/dev/tty.usbmodemXXXX" on macOS)
...
void serialEvent(Serial myPort) { // starts reading data from the Serial Port
  ...
  angle = data.substring(0, index1); // angle the Arduino sent
